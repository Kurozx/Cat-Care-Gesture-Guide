...
export function Auth({ navigate }: ScreenProps) {
  ...
  return <View style={{ gap: 20 }}><View style={{ alignItems: 'center' }}><CatArt size={110} /></View><Text accessibilityRole="header" style={[s.title, { textAlign: 'center' }]}>{register ? 'สร้างบัญชีผู้ใช้' : 'เข้าสู่ระบบ'}</Text>
