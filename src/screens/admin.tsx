...
const fields: Partial<Record<AdminTable, FormField[]>> = {
  ...
  cats: [{key:'name',label:'ชื่อแมว',required:true},{key:'breed',label:'สายพันธุ์'},{key:'microchip_code',label:'เลขไมโครชิป'},{key:'birth_date',label:'วันเกิด (YYYY-MM-DD)',nullable:true},{key:'notes',label:'หมายเหตุ',multiline:true}],
